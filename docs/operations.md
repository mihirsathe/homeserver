...
### 32 GB RAM — and memory ceilings now sum to 29.75 GB of it
...
26.75 GB to 30.75 GB; removing Lidarr (2026-09-01, see decisions.md) took its 1 GB ceiling
back out, landing at **29.75 GB**. Ceilings are limits, not reservations, and every tenant
here is bursty or schedulable — nothing reserves what it declares — but this is tighter than
the 31.25 GB that was previously flagged as having no headroom for error, so it is written
